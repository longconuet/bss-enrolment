...
namespace Enrolment.Migrations
{
    ...
    [Migration("20230221074608_addImageTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Enrolment.Models.EmailRegister", b =>
                {
                    ...
                    b.Property<int?>("IdentityProofImageId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdentityProofImageId")
                        .IsUnique()
                        .HasFilter("[IdentityProofImageId] IS NOT NULL");
            ...
            modelBuilder.Entity("Enrolment.Models.IdentityProofImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Enrolment.Models.EmailRegister", b =>
                {
                    ...
                    b.HasOne("Enrolment.Models.IdentityProofImage", "IdentityProofImage")
                        .WithOne("EmailRegister")
                        .HasForeignKey("Enrolment.Models.EmailRegister", "IdentityProofImageId");
                    ...
                    b.Navigation("IdentityProofImage");
